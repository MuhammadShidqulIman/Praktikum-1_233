            ...
            <div class="bg-[#242b3d] overflow-hidden shadow-xl sm:rounded-xl border border-gray-700/50">
                <div class="p-8 text-gray-100">
                    ...
                    <div class="mb-8">
                        ...
                        <h2 class="text-2xl font-bold text-white tracking-wide">Add Category</h2>
                    ...
                    <form action="{{ route('kategori.store') }}" method="POST">
                        ...
                        <div class="mb-8">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" 
                                   class="block w-full bg-[#374151] border-transparent text-white focus:border-indigo-500 focus:ring-indigo-500 rounded-lg shadow-sm py-2.5 px-4 placeholder-gray-500" 
